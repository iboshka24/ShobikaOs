...
echo "=== Step 3: Disable Pacman signature verification & enable parallel downloads ==="
...
echo "=== Step 4: Update pacman database with retries ==="
for i in {1..5}; do
  pacman -Sy --noconfirm && break || sleep 3
done

echo "=== Step 5: Install build tools with retries ==="
for i in {1..5}; do
